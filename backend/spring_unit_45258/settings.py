"""
Django settings for spring_unit_45258 project.
...
ROOT_URLCONF = 'spring_unit_45258.urls'
...
WSGI_APPLICATION = 'spring_unit_45258.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_unit_45258 API",
    "DESCRIPTION": "API documentation for spring_unit_45258 App",
    "VERSION": "v1",
}
